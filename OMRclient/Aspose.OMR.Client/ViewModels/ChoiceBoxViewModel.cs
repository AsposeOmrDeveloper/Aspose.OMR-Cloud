...
namespace Aspose.OMR.Client.ViewModels
{
    ...
    public sealed class ChoiceBoxViewModel : BaseQuestionViewModel
    {
        ...
        public ChoiceBoxViewModel(string name, double top, double left, double width, double height)
        {
        ...
        public ChoiceBoxViewModel(string name, Rect area)
        {
        ...
        private void UpdateBubbleCount(int newCount)
        {
        ...
        private void FitBubblesHorizontal(int count)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                var bubble = new BubbleViewModel(bubbleWidth, bubbleHeight, BorderOffset, leftPosition);
