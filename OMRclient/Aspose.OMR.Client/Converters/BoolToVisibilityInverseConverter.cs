...
namespace Aspose.OMR.Client.Converters
{
    ...
    /// <summary>
    /// Inversed bool to visibility converter
    /// </summary>
    public class BoolToVisibilityInverseConverter : MarkupExtension, IValueConverter
    {
        private static BoolToVisibilityInverseConverter converter;
        ...
        {
            return converter ?? (converter = new BoolToVisibilityInverseConverter());
        }
    }
}
